...
From the previous charts, we can find that when add one more community college, the best location is Rochester, but the total weighted distance decrease least. However, after that if we add one more again, the best location is Islip, and this time the total weighted distance decrease a lot. 
